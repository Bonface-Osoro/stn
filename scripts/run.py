...
transmitter_x = [10, 10, 35, 60, 60]
transmitter_y = [10, 10, 35, 60, 60]
...
for technology in technologies:
    for tx in transmitter_x:
        for ty in transmitter_y:
            for rx in range(receiver_x):
                for ry in range(receiver_y):
                    for ix in interference_x:
                        for iy in interference_y:

                            if tx == rx or ty == ry or tx == ix or ty == iy:
                                break
                            else:
                                link_budget = LinkBudget(40, 16, technology, tx, ty, rx, ry, ix, iy)
